...
static void small_help() {
    std::cout <<
    "usage: ./metric [-h] --real REAL --gen GEN --out OUT [--min_shift MIN_SHIFT]" << std::endl <<
    ...
    "./metric: error: the following arguments are required: --real, --gen, --out" << std::endl;
}

static void help() {
    std::cout <<
    "usage: metric.py [-h] --real REAL --gen GEN --out OUT [--min_shift MIN_SHIFT]" << std::endl <<
    "             [--max_shift MAX_SHIFT] [--min_theta MIN_THETA]" << std::endl <<
    "             [--max_theta MAX_THETA] [--min_scale MIN_SCALE]" << std::endl <<
    "             [--max_scale MAX_SCALE] [--grid_step GRID_STEP]" << std::endl <<
    ...
    "                        poly1 etc" << std::endl <<
    "  --out OUT             output file name" << std::endl << std::endl <<
